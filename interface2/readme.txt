...
e daí gerar os registros de parcelas a serem pagas (data e valor),sendo a primeira parcela a ser paga um mês 
após a data do contrato, a segunda parcela doismeses após o contrato e assim por diante. Mostrar os dados das 
parcelas na tela.
...
-- Services
- PagamentoOnline (IMPLEMENT)
    Double Taxa de pagamento (quantia)
    Double Vencimento (quantia, mesesdevenciemento)

- Serviço Paypal
    Taxa de pagamento = quantia * 0,02;
    Vencimento = quantia * 0,01 * mes;
